...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Input
    {
        ...
        public static Valve.VR.SteamVR_Input_ActionSet_CalebDemoActions CalebDemoActions;
        ...
        {
            SteamVR_Input.CalebDemoActions.Initialize();
        ...
        {
            Valve.VR.SteamVR_Input.CalebDemoActions = ((SteamVR_Input_ActionSet_CalebDemoActions)(SteamVR_Input_References.GetActionSet("CalebDemoActions")));
            ...
            {
                    Valve.VR.SteamVR_Input.CalebDemoActions,
