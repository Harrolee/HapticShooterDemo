...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Input
    {
        ...
        public static SteamVR_Action_Boolean __actions_CalebDemoActions_in_Shoot;
        
        public static SteamVR_Action_Pose __actions_CalebDemoActions_in_Pose;
        
        public static SteamVR_Action_Skeleton __actions_CalebDemoActions_in_SkeletonRightHand;
        
        public static SteamVR_Action_Skeleton __actions_CalebDemoActions_in_SkeletonLeftHand;
        
        public static SteamVR_Action_Boolean __actions_CalebDemoActions_in_OpenMenu;
        ...
        {
            SteamVR_Input.__actions_CalebDemoActions_in_Shoot.Initialize();
            SteamVR_Input.__actions_CalebDemoActions_in_Pose.Initialize();
            SteamVR_Input.__actions_CalebDemoActions_in_SkeletonRightHand.Initialize();
            SteamVR_Input.__actions_CalebDemoActions_in_SkeletonLeftHand.Initialize();
            SteamVR_Input.__actions_CalebDemoActions_in_OpenMenu.Initialize();
        ...
        {
            Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_Shoot = ((SteamVR_Action_Boolean)(SteamVR_Input_References.GetAction("__actions_CalebDemoActions_in_Shoot")));
            Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_Pose = ((SteamVR_Action_Pose)(SteamVR_Input_References.GetAction("__actions_CalebDemoActions_in_Pose")));
            Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_SkeletonRightHand = ((SteamVR_Action_Skeleton)(SteamVR_Input_References.GetAction("__actions_CalebDemoActions_in_SkeletonRightHand")));
            Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_SkeletonLeftHand = ((SteamVR_Action_Skeleton)(SteamVR_Input_References.GetAction("__actions_CalebDemoActions_in_SkeletonLeftHand")));
            Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_OpenMenu = ((SteamVR_Action_Boolean)(SteamVR_Input_References.GetAction("__actions_CalebDemoActions_in_OpenMenu")));
            ...
            {
                    Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_Shoot,
                    Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_Pose,
                    Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_SkeletonRightHand,
                    Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_SkeletonLeftHand,
                    Valve.VR.SteamVR_Input.__actions_CalebDemoActions_in_OpenMenu,
